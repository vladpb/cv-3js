...
const npmConfigFromPnpmWorkspace = (0, fast_memoize_1.default)(async (options) => {
    ...
    if (!pnpmWorkspacePath)
        return {};
    const pnpmWorkspaceConfigPath = path_1.default.join(path_1.default.dirname(pnpmWorkspacePath), '.npmrc');
    ...
    const config = (0, npm_1.normalizeNpmConfig)(ini_1.default.parse(pnpmWorkspaceConfig));
