...
${chalk_1.default.cyan('groupFunction')}: (name, defaultGroup, currentSpec, upgradedSpec, upgradedVersion) ${chalk_1.default.cyan('=>')} {
  ${chalk_1.default.red('if')} (name ${chalk_1.default.red('===')} ${chalk_1.default.yellow(`'typescript'`)} && defaultGroup ${chalk_1.default.red('===')} ${chalk_1.default.yellow(`'minor'`)}) {
